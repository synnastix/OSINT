...
while True:
	...
	for paste in paste_list_json:
	    ...
	    raw_paste_data = requests.get(raw_paste_uri).content
	    ...
	    if len(results) > 0:
	        decoded_paste_data = raw_paste_data.decode('utf-8')
	        md5 = hashlib.md5(decoded_paste_data).hexdigest()
	        sha256 = hashlib.sha256(decoded_paste_data).hexdigest()
	        paste_data['MD5'] = md5
