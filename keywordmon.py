...
#alert_email_account  = "email_address" <- add gmail account and uncomment
#alert_email_password = "password_here" <- add gmail password and uncomment
...
signal.signal(signal.SIGINT, cc)
